...
module.exports = function (grunt) {
  ...
  jsFileToViewSpecific = jsFileToViewSpecific.map(function (path) {
    return '.tmp/public/' + path;
  });
    ...
    'sails-linker': {
      ...
      devJs: {
        ...
        files: {
          ...
          'views/user/show.html':  jsFileToViewSpecific,
          'views/user/show.ejs' :  jsFileToViewSpecific
        }
      },
